...
describe CommentsController do
  ...
  let(:valid_attributes) { { "commentbody" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved comment as @comment" do
        ...
        post :create, {:comment => { "commentbody" => "invalid value" }}, valid_session
        assigns(:comment).should be_a_new(Comment)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested comment" do
        ...
        Comment.any_instance.should_receive(:update).with({ "commentbody" => "MyString" })
        put :update, {:id => comment.to_param, :comment => { "commentbody" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the comment as @comment" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Comment.any_instance.stub(:save).and_return(false)
        put :update, {:id => comment.to_param, :comment => { "commentbody" => "invalid value" }}, valid_session
        assigns(:comment).should eq(comment)
      end
