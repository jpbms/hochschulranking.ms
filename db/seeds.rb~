...
University.create({"id"=>4, "campus"=>true, "name"=>"FH Münster", "website"=>"https://www.fh-muenster.de/index.php", "hs_type"=>"FH" , "address_id"=> 4, "picture_id"=>4})
...
University.create({"id"=>11, "name"=>"FH Flensburg", "website"=>"http://www.fh-flensburg.de/fhfl/index.php", "hs_type"=>"FH" , "address_id"=> 11, "picture_id"=>11})
University.create({"id"=>12, "name"=>"Uni Flensburg", "website"=>"http://www.uni-flensburg.de/?989", "hs_type"=>"Uni" , "address_id"=> 12, "picture_id"=>12})
University.create({"id"=>13, "name"=>"FH Kiel", "website"=>"http://www.fh-kiel.de/", "hs_type"=>"FH" , "address_id"=> 13, "picture_id"=>13})
University.create({"id"=>14, "name"=>"Uni Kiel", "website"=>"http://www.uni-kiel.de/", "hs_type"=>"Uni" , "address_id"=> 14, "picture_id"=>14})
University.create({"id"=>15, "name"=>"MH Lübeck", "website"=>"http://www.mh-luebeck.de/start/", "hs_type"=>"MH" , "address_id"=> 15, "picture_id"=>15})
University.create({"id"=>16, "name"=>"Uni Greifswald", "website"=>"http://www.uni-greifswald.de/", "hs_type"=>"Uni" , "address_id"=> 16, "picture_id"=>16})
University.create({"id"=>17, "name"=>"Uni Rostock", "website"=>"http://www.uni-rostock.de/", "hs_type"=>"Uni" , "address_id"=> 17, "picture_id"=>17})
University.create({"id"=>18, "name"=>"DH Schwerin", "website"=>"http://www.design-hochschule.de/", "hs_type"=>"DH" , "address_id"=> 18, "picture_id"=>18})
University.create({"id"=>19, "name"=>"FH Stralsund", "website"=>"http://www.fh-stralsund.de/fh_stralsund/powerslave,id,223,nodeid,.html", "hs_type"=>"FH" , "address_id"=> 19, "picture_id"=>19})
University.create({"id"=>20, "name"=>"HS Wismar", "website"=>"http://www.hs-wismar.de/startseite", "hs_type"=>"HS" , "address_id"=> 20, "picture_id"=>20})
University.create({"id"=>21, "name"=>"Uni Hamburg", "website"=>"http://www.uni-hamburg.de/", "hs_type"=>"Uni" , "address_id"=> 21, "picture_id"=>21})
University.create({"id"=>22, "name"=>"TU Hamburg-Harburg", "website"=>"http://www.tuhh.de/tuhh/startseite.html", "hs_type"=>"TU" , "address_id"=> 22, "picture_id"=>22})
University.create({"id"=>23, "name"=>"Uni Bremen", "website"=>"http://www.uni-bremen.de/", "hs_type"=>"Uni" , "address_id"=> 23, "picture_id"=>23})
University.create({"id"=>24, "name"=>"HS Bremen", "website"=>"http://www.hs-bremen.de/internet/de/", "hs_type"=>"HS" , "address_id"=> 24, "picture_id"=>24})
University.create({"id"=>25, "name"=>"TU Braunschweig", "website"=>"https://www.tu-braunschweig.de/", "hs_type"=>"TU" , "address_id"=> 25, "picture_id"=>25})
University.create({"id"=>26, "name"=>"Uni Hannover", "website"=>"http://www.uni-hannover.de/de/", "hs_type"=>"Uni" , "address_id"=> 26, "picture_id"=>26})
University.create({"id"=>27, "name"=>"Uni Oldenburg", "website"=>"http://www.uni-oldenburg.de/", "hs_type"=>"Uni" , "address_id"=> 27, "picture_id"=>27})
University.create({"id"=>28, "name"=>"Uni Halle-Wittenberg", "website"=>"http://www.uni-halle.de/", "hs_type"=>"Uni" , "address_id"=> 28, "picture_id"=>28})
University.create({"id"=>29, "name"=>"Uni Magdeburg", "website"=>"http://www.ovgu.de/", "hs_type"=>"Uni" , "address_id"=> 29, "picture_id"=>29})
University.create({"id"=>30, "name"=>"HS Harz", "website"=>"http://www.hs-harz.de/", "hs_type"=>"HS" , "address_id"=> 30, "picture_id"=>30})
University.create({"id"=>31, "name"=>"FH Brandenburg", "website"=>"http://www.fh-brandenburg.de/", "hs_type"=>"FH" , "address_id"=> 31, "picture_id"=>31})
University.create({"id"=>32, "name"=>"TU Cottbus-Senftenberg", "website"=>"http://www.b-tu.de/b-tu/", "hs_type"=>"TU" , "address_id"=> 32, "picture_id"=>32})
University.create({"id"=>33, "name"=>"EU Frankfurt an der Oder", "website"=>"http://www.europa-uni.de/de/index.html", "hs_type"=>"EU" , "address_id"=> 33, "picture_id"=>33})
University.create({"id"=>34, "name"=>"Uni Potsdam", "website"=>"http://www.uni-potsdam.de/", "hs_type"=>"Uni" , "address_id"=> 34, "picture_id"=>34})
University.create({"id"=>35, "name"=>"TU Chemnitz", "website"=>"http://www.tu-chemnitz.de/", "hs_type"=>"TU" , "address_id"=> 35, "picture_id"=>35})
University.create({"id"=>36, "name"=>"TU Dresden", "website"=>"http://tu-dresden.de/", "hs_type"=>"TU" , "address_id"=> 36, "picture_id"=>36})
University.create({"id"=>37, "name"=>"Uni Leipzig", "website"=>"http://www.zv.uni-leipzig.de/", "hs_type"=>"Uni" , "address_id"=> 37, "picture_id"=>37})
...
University.create({"id"=>40, "campus"=>false, "name"=>"design akademie berlin - Hochschule für Kommunikation und Design Berlin", "website"=>"http://www.design-akademie-berlin.de/", "hs_type"=>"Uni" , "address_id"=> 40, "picture_id"=>40})
